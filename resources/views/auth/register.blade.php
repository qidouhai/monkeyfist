                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('prename') ? ' has-error' : '' }}">
                                <label for="prename" class="col-md-4 control-label">Prename</label>
                            ...
                            <div class="form-group {{ $errors->has('birthday') ? 'has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday" type="text" class="form-control" name="birthday" value="{{ old('birthday') }}" placeholder="yyyy-mm-dd" required>
